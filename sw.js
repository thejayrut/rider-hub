const CACHE='riderhub-stable-v39';
const ASSETS=['./','./index.html','./stable-app.css','./stable-compat.css','./premium-polish.css','./stable-app.js','./stable-auth.js','./premium-polish.js','./account-scope-guard.js','./product-finish.js','./firebase-config.js','./motorcycle-catalog.js','./manual-reader.js','./cloud-drive-v2.js','./manifest.webmanifest','./icon-192.svg','./icon-512.svg','./icon-maskable.svg'];
