const CACHE='riderhub-stable-v35';
const ASSETS=['./','./index.html','./stable-app.css','./stable-compat.css','./stable-app.js','./stable-auth.js','./stable-ui-fixes.js','./firebase-config.js','./motorcycle-catalog.js','./manual-reader.js','./cloud-drive-v2.js','./manifest.webmanifest','./icon-192.svg','./icon-512.svg','./icon-maskable.svg'];
