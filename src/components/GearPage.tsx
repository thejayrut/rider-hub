...
export function GearPage(){
  ...
  return <>
    ...
    <div className="dataNote">Prices marked unknown are intentionally left blank rather than guessed. Every item remains editable.</div>
